...
void __fastcall TForm2::FormActivate(TObject *Sender)
{
   ...
   {
	  Form2->sComboBox1->Items->Add("Дисциплины отсутствуют!");
   }
}
//---------------------------------------------------------------------------
void __fastcall TForm2::sComboBox1Change(TObject *Sender)
{
   ...
   if(DataModule1->ADOQuery1->IsEmpty())
   {
	  Form2->sComboBox2->Items->Add("Темы отсутствуют!");
   }
}
//---------------------------------------------------------------------------
...
void __fastcall TForm2::sButton2Click(TObject *Sender)
{
   ...
   {
	   ShowMessage("Простите, но вопросы по заданной теме пока отсутствуют! \n"
	   "Пройдите другой тест.");
   }
   else
   {
  Form2->Hide();
