...
{
   Form6->sButton6->Caption="Отчет по заданной группе и дисциплине.";
   Form6->sButton4->Caption="Отчет по заданному студенту и числу.";
   Form6->sComboBox8->Text="Выберите дисциплину!";
   Form6->sComboBox9->Text="Выберите тему!";
   ...
   Form6->sLabel8->Caption="Изменение критериев оценки. Введите сумму баллов для оценки 5:";
   Form6->sEdit5->Text="Введите число баллов для оценки 5!";
   Form6->sEdit5->Text="Введите число баллов для оценки 5!";
   Form6->sButton8->Caption="Изменить критерий оценки";
   Form6->sButton9->Caption="Добавить оценку оценку";
...
void __fastcall TForm6::sButton3Click(TObject *Sender)
{
  ...
  DataModule1->ADOQuery3->Close();
   ...
   Form6->sEdit1->Text="";
   ShowMessage("Дисциплина добавлена успешно!");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm6::sButton5Click(TObject *Sender)
{
  ...
  DataModule1->ADOQuery3->Close();
   ...
   Form6->sEdit2->Text="";
  ShowMessage("Тема добавлена успешно!");
}
//---------------------------------------------------------------------------
...
" and ThemeName="+ QuotedStr(Form6->sComboBox5->Text)+";");
   ...
   Form6->sEdit4->Text="";
   ShowMessage("Вопрос добавлен успешно!");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm6::sButton7Click(TObject *Sender)
{
   ...
   DataModule1->ADOQuery3->ExecSQL();
   Form6->sEdit3->Text="";
   ShowMessage("Ответ добавлен успешно!");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm6::sButton8Click(TObject *Sender)
{
   ...
   DataModule1->ADOQuery3->Open();
   if (DataModule1->ADOQuery3->IsEmpty()) {
	  ShowMessage("Отсутствуют данные об оценках!");
   } else
   {
  DataModule1->ADOQuery3->Close();
   DataModule1->ADOQuery3->SQL->Clear();
   DataModule1->ADOQuery3->SQL->Text=("exec Формирование_оценки "
...
void __fastcall TForm6::sButton9Click(TObject *Sender)
{
  DataModule1->ADOQuery3->Close();
   DataModule1->ADOQuery3->SQL->Clear();
   DataModule1->ADOQuery3->SQL->Text=("exec Формирование_оценки1 "
